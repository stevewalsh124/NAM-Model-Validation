...
plot(g5) + scale_colour_manual(values = cols, limits = c("4", "6", "8", "10"))
...
ggplot(PW_mean/sqrt(S2))
plot(g5) + scale_colour_manual(values = c("red","green","blue","black"), limits = c("4", "6", "8", "10"))
