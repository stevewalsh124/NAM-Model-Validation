...
```{r plot.all.47}
# pdf("LogPrecipVariograms_km_LCC_skip2_7_27wDIRVAR.pdf") #*#**###*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#**#**##*#*#*#*#*#*#*#*
all.storm.folders <- list.dirs("NAMandST4", recursive = F) #/Volumes/LACIEHD/
most.storm.folders <- list.dirs("NAMandST4", recursive = F)[-c(2,7,27)] #/Volumes/LACIEHD/
...
# write.csv(svg.param.ests.error, "svg.param.ests.error_KM_LCC_skip2.csv")
