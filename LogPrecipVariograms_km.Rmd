...
```{r plot.all.47}
pdf("LogPrecipVariograms_km_LCC_MaternSVGestimates.pdf") #*#**###*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#**#**##*#*#*#*#*#*#*#*
all.storm.folders <- list.dirs("NAMandST4", recursive = F) #/Volumes/LACIEHD/
most.storm.folders <- list.dirs("NAMandST4", recursive = F)[-c(2,5,16,22,25,35,47)] #/Volumes/LACIEHD/
...
for(i in 1:length(most.storm.folders)){
  ...
  colnames(ST4_df) <- c("value", "x", "y")
    write.csv(NAM_df, paste0("csv/INLAvsWLS/ST4/namdf_",storm_year,storm_name,"_",radius,"km.csv"))
...
svg.param.ests.error <- cbind(all.storm.names,all.storm.years,phivec,prRangevec,tau2vec,sig2vec, kappavec)
write.csv(svg.param.ests.error, "csv/INLAvsWLS/svg.param.ests.error_KM_LCC_MaternSVGestimates.csv")
print(svg.param.ests.error)
