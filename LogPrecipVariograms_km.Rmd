...
```{r plot.all.47}
# pdf("logbuffer.boots.KM/logbuffer.boots.46to47.pdf") #*#**###*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#**#**##*#*#*#*#*#*#*#*#*#*#*#*
all.storm.folders <- list.dirs("NAMandST4", recursive = F) #/Volumes/LACIEHD/
most.storm.folders <- list.dirs("NAMandST4", recursive = F)[46:47] #/Volumes/LACIEHD/
...
mask <- projectRaster(mask, raster("nam_218_20050829_1200_f012.grib"), method = 'ngb')
mask.regrid <- resample(mask, raster("nam_218_20050829_1200_f012.grib"), method='ngb')
...
for(i in 1:length(most.storm.folders)){
  ...
  for (k in 1:length(list.files(ST4_folder,full.names = T)[1:4])) {
    ...
    ST4list[[i]][[k]] <- (raster(ST4file) %>% projectRaster(crs="+proj=lcc +lat_1=25 +lat_2=25 +lat_0=25 +lon_0=-95 +x_0=0 +y_0=0 +a=6371200 +b=6371200 +units=m +no_defs "))
  ...
  for (j in 1:length(list.files(NAM_folder,full.names = T)[first24])) {
    ...
    print(NAM_band)
    NAMlist[[i]][[j]] <- (raster(NAMfile, band=NAM_band) %>% projectRaster(crs = "+proj=lcc +lat_1=25 +lat_2=25 +lat_0=25 +lon_0=-95 +x_0=0 +y_0=0 +a=6371200 +b=6371200 +units=m +no_defs"))
  ...
  hurdat[,8:7]<-project(as.matrix(hurdat[,8:7]), "+proj=lcc +lat_1=25 +lat_2=25 +lat_0=25 +lon_0=-95 +x_0=0 +y_0=0 +a=6371200 +b=6371200")
  ...
  radius <- 70000000 #this became meters instead of degrees so I multiplied by 1e5
  ...
  initial.values <- expand.grid(seq(0.01, 6, by=.02), seq(0.01, 1e6, by=10000))
