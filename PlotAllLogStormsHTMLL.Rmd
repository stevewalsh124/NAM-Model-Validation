...
```{r plot.all.41}
pdf("log_trouble_trials.pdf")
all.storm.folders <- list.dirs("/Volumes/LACIEHD/NAMandST4trouble", recursive = F) #G:\\NAMandST4
NAMlist <- list()
ST4list <- list()
...
mask.regrid <- resample(mask, projectRaster(raster("/Volumes/LACIEHD/nam_218_20050829_1200_f012.grib"),crs = "+proj=longlat +datum=WGS84"), method='ngb')
