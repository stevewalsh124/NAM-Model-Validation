...
load(paste0("~/NAM-Model-Validation/RData/Gibbs_sqrt_LM3",
...
write.csv(ests, paste0(file = "~/NAM-Model-Validation/csv/prediction/", pred_dir,"_sqrt_LM3_",
                       PWstamp,".csv"))
...
save.image(paste0("~/NAM-Model-Validation/RData/prediction/prediction",ste,"_LM3_",PWstamp,".RData"))
dev.off()
