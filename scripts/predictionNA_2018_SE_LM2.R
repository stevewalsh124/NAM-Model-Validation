...
load(file = paste0("RData/Gibbs_sqrt_LM2",
...
write.csv(ests, paste0(file = "csv/prediction/", pred_dir,"_sqrt_LM2_",
                       PWstamp,".csv"))
...
save.image(paste0("RData/prediction/prediction",ste,"_LM2_",PWstamp,".RData"))
dev.off()
