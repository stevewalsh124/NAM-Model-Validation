...
load(file = paste0("~/NAM-Model-Validation/RData/Gibbs_sqrt_LM2",
...
for (i in 1:Ngen) {
  theta_pred[i,] <- rmvn(1, mu_burn[10*i,], as.square(Sigma_burn[10*i,]))
  }
...
write.csv(ests, paste0(file = "~/NAM-Model-Validation/csv/prediction/", pred_dir,"_sqrt_LM2_",
                       PWstamp,".csv"))
...
save.image(paste0("~/NAM-Model-Validation/RData/prediction/prediction",ste,"_LM2_",PWstamp,".RData"))
dev.off()
