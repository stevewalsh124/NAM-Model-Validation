...
```{r plot.all.47}
# pdf("pdf/47storms_km.pdf")   #    ("LogPrecipVariograms_km_LCC_MaternSVGestimates.pdf") #*#**###*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#**#**##*#*#*#*#*#*#*#*
all.storm.folders <- list.dirs("/Volumes/LACIEHD/NAMandST4", recursive = F) #/Volumes/LACIEHD/
most.storm.folders <- list.dirs("/Volumes/LACIEHD/NAMandST4", recursive = F)#[-c(2,5,7,16,22,25,35,47)] #/Volumes/LACIEHD/
...
NAM_km_for_mask <- projectRaster(raster("~/NAM-Model-Validation/nam_218_20170826_0000_012.grb2"),
...
for(i in 1:length(most.storm.folders)){
  ...
  writeRaster(error, paste0("/Volumes/LACIEHD/error_rasters_km/",storm_year,storm_name), overwrite=T) 
