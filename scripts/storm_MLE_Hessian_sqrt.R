...
par_calcy <- foreach(co=1:cores, .combine= 'comb',
                      .init=list(list(), list(), list(), list(),
                       ...
                       storm_file <- list.files("~/NAM-Model-Validation/csv/error_df_sqrt/subtractPWmeanT_flat",
                       ...
                       #' #}
                       list(name_Ivec, NULL, NULL,NULL, NULL, 
...
if(exists("par_calcy")){save.image(file=paste0("~/NAM-Model-Validation/RData/RData",
                                          ...
                                          storms_char,"_sqrt_",nowtime(),"_NAmask_estsmooth0501",
...
if(!dir.exists("~/NAM-Model-Validation/csv/MLEestimates_sqrt_buffer_ngb_PWmean/")){
  dir.create("~/NAM-Model-Validation/csv/MLEestimates_sqrt_buffer_ngb_PWmean/")
}
write.csv(par_calcy_vec,paste0("~/NAM-Model-Validation/csv/MLEestimates_sqrt_buffer_ngb_PWmean/MLEvsINLAstorms",
