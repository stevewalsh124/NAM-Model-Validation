...
lambda_files <- list.files("csv/myMLEresults/myMLEs/", 
...
# load(file = paste0("RData/Gibbs_sqrt_LM4",
...
write.csv(ests, paste0(file = "csv/prediction/", pred_dir,"_sqrt_LM4_",
                       PWstamp,".csv"))
...
save.image(paste0("RData/prediction/prediction",ste,"_LM4_",PWstamp,".RData"))
dev.off()
