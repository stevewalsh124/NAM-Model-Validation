...
par(mfrow=c(2,2))
plot(ST4_r - NAM_r, main="error field")
...
# assumption of a normal predictive density
mean(UQ_NAM2_crps < orig_NAM2_crps)
mean(UQ_NAM2_crps[ST4_pred$value > 1] < orig_NAM2_crps[ST4_pred$value > 1])
mean(UQ_NAM2_crps[ST4_pred$value > 5] < orig_NAM2_crps[ST4_pred$value > 5])
mean(UQ_NAM2_crps[ST4_pred$value > 10] < orig_NAM2_crps[ST4_pred$value > 10])

# nonparametric, using an empirical CDF
mean(np_CRPS2 < orig_NAM2_crps)
mean(np_CRPS2[ST4_pred$value > 1] < orig_NAM2_crps[ST4_pred$value > 1])
mean(np_CRPS2[ST4_pred$value > 5] < orig_NAM2_crps[ST4_pred$value > 5])
