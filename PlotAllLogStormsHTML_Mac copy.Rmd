...
most.storm.folders <- list.dirs("/Volumes/LACIEHD/NAMandST4", recursive = F)[39]#[-c(1,12:36)] #
...
for(i in 1:length(most.storm.folders)){
  ...
  vario.plot <- plot(simul.modvar,main=paste0("SVG for ", storm_year," ",storm_name), ylim=c(0,2));lines(sim.mod.cressie,col="orange")#;lines(sim.mod.cressie.nug,col="red")
