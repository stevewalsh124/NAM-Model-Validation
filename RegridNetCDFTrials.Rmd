...
centerLat <- 28.90
centerLon <- -97.30
deg15nc <- nc_open("/Users/stephenwalsh/Downloads/test_timetest-1_15degs.nc")
timetest_15deg <- raster("/Users/stephenwalsh/Downloads/test_timetest-1_15degs.nc") #flipped axes in R
precip.matrix <- matrix(values(timetest_15deg), nrow = length(deg15nc$dim$lat$vals))
